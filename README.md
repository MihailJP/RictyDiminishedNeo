...
[Inconsolata EX](https://github.com/MihailJP/Inconsolata-LGC) ベースに変更したものです。
...
バージョン 3.000 以降、Inconsolata LGC から Inconsolata EX に変更しました。
これにより、結合文字やアラビア文字が追加されています。
